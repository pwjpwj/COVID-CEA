---
title: "Análisis de coste-efectividad de Sotrovimab para pacientes con COVID-19 de alto riesgo"
...
# Análisis de coste eficacia de Sotrovimab para el tratamiento del covid leve
...
## Rama con Sotrovimab con datos reportados en Gupta et al. NEJM oct 2021
## Probabilidades del árbol decisional
```{r}
ProbIng=0.4*0.15 #MASS>=5
ProbICU=0.001
ProbExitusICU=0.3
ProbExitus=0.05
...
La renta per cápita de España en 2021 fue de 23470 Euros. Por tanto el Ratio de coste-efectividad incremental de Sotrovimab sería considerado como coste-efectivo.
